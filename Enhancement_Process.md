...
With the metadata correctly applied, the player squeezes the enhanced video's display width from 1440 to 1280 pixels in the same way, giving both videos identical proportions and making the comparison meaningful.
